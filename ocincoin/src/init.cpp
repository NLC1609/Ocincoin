...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ocincoin-project/ocincoin>";
    const std::string URL_WEBSITE = "<https://ocincoin.org>";
