...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ocincoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ocincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ocincoin transaction") + "\n" +
              "  ocincoin-tx [options] -create [commands]   " + _("Create hex-encoded ocincoin transaction") + "\n" +
              "\n";
