...
const char * const BITCOIN_CONF_FILENAME = "ocincoin.conf";
const char * const BITCOIN_PID_FILENAME = "ocincoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ocincoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ocincoin";
#else
    // Unix
    return pathRet / ".ocincoin";
#endif
#endif
}
