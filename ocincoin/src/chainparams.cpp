...
{
    const char* pszTimestamp = "The Ocincoin by N.L.C on 17/8/2021";
    const CScript genesisOutputScript = CScript() << ParseHex("057684710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1629202500, 2002009507, 0x1e0ffff0, 1, 75 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc409d2f59d505d5f2dd93961f65aa953864f3ccdbd0c0c1c73c4d2cab7bf09c9"));
        assert(genesis.hashMerkleRoot == uint256S("0xeeaa97fb741f82975fd3190cf04ba1115e3bc70c16a6bbf5d1b37cac712f3eee"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("118.200.11.15", "118.200.11.15", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("ocincointools.com", "dnsseed.ocincointools.com"));
        //vSeeds.push_back(CDNSSeedData("ocincoinpool.org", "dnsseed.ocincoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xc409d2f59d505d5f2dd93961f65aa953864f3ccdbd0c0c1c73c4d2cab7bf09c9"))
        ...
        chainTxData = ChainTxData{
            ...
            1629202500, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1629202500, 420273, 0x1e0ffff0, 1, 75 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe08bf0a04aba57b80855fed8cc8eb910128f5a30c48a931c4267a8fe5bfc30ab"));
        assert(genesis.hashMerkleRoot == uint256S("0xeeaa97fb741f82975fd3190cf04ba1115e3bc70c16a6bbf5d1b37cac712f3eee"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("118.200.11.15", "118.200.11.15"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.ocincoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xe08bf0a04aba57b80855fed8cc8eb910128f5a30c48a931c4267a8fe5bfc30ab ")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1629202500, 0, 0x207fffff, 1, 75 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x326632fa05dcc582a2d4bb0e494bd18d98f223e43a04ccebcf9406d622a0938e"));
        assert(genesis.hashMerkleRoot == uint256S("0xeeaa97fb741f82975fd3190cf04ba1115e3bc70c16a6bbf5d1b37cac712f3eee"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x326632fa05dcc582a2d4bb0e494bd18d98f223e43a04ccebcf9406d622a0938e"))
        };
